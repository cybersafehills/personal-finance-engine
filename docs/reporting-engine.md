...
| Concern | Location |
|---|---|
| Schema, RLS | `supabase/migrations/20260902000000_phase_j_reporting_foundation.sql` (core tables), `20260903000000_phase_k_report_artifacts.sql` (PDF artifacts + storage bucket) |

...
import { isOnboardingJourneyEnabled } from "../../lib/onboarding/journey";
...
export default async function GetStartedPage() {
  ...
  // When the milestone journey is on, the linear /onboarding wizard IS
  // the flow; this route just resumes it.
  if (isOnboardingJourneyEnabled()) redirect("/onboarding");

...
// Begin the OAuth consent flow for a cloud-storage destination.
// Session-authenticated via the app middleware. While a provider is dark
// (no *_CLIENT_ID / *_SECRET) this returns 501 - it never redirects to a
...
export async function GET(
  ...
  const authUrl = getCloudStorageClient(provider).authUrl({
    redirectUri,
    state,
